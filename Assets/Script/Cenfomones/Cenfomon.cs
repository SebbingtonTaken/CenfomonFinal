...
public class Cenfomon 
{
    ...
    public void Init()
    {
        ...
        // this.SpecialAction = new SonidoSecreto(6);
    ...
    public void ApplyBoosts(List<StatBoost> statBoosts)
    {
        foreach (var statBoost in statBoosts)
        {
            ...
            if (boost > 0)
                StatusChanges.Enqueue($"{Base.Name}'s {stat} subió!");
            else
                StatusChanges.Enqueue($"{Base.Name}'s {stat} bajó!");

            Debug.Log($"{stat} ha mejorado {StatBoosts[stat]}");
        }
    }
