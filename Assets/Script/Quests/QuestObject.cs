...
public class QuestObject : MonoBehaviour
{
    ...
    public void UpdateObjectStatus()
    {
        ...
        // if(questToCheck.name=="PatoSabiduria"){
        //     foreach (Cenfomon cenfomon in FindObjectOfType<PlayerController>().GetComponent<CenfomonParty>().Cenfomons){
        //         cenfomon.SpecialAction.CondicionSecreta = true;
        //     }
        // }
